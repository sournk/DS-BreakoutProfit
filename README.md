...
- [ ] `AtrRatioTp`: Коэффициент ATR TP
- [ ] `AtrRatioSl`: Коэффициент ATR SL
- [x] `OP_Shift`: Отступ
- [x] `gLot`: Лот
...
### Основные фичи
- [ ] Если цена в момент размещения ордеров вне диапазона, то бот ни один открывает ни один ордер (XAUUSD, 2017-03-27).
